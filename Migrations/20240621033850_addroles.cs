        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    WeixinCode = table.Column<string>(type: "TEXT", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Room_AspNetUsers_CreateUserId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UserHeadImgContent = table.Column<byte[]>(type: "BLOB", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserHeadImg", x => x.Id);
                    table.ForeignKey(
                        name: "FK_UserHeadImg_AspNetUsers_ApplicationUserId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_RoomPlayer_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ScoreItem_AspNetUsers_FromUserId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RoomPlayer_UserId",
                table: "RoomPlayer",
                column: "UserId");

            migrationBuilder.CreateIndex(
                name: "IX_ScoreItem_FromUserId",
                table: "ScoreItem",
                column: "FromUserId");

            migrationBuilder.CreateIndex(
                name: "IX_ScoreItem_RoomId",
                table: "ScoreItem",
                column: "RoomId");

            migrationBuilder.CreateIndex(
                name: "IX_UserHeadImg_ApplicationUserId",
                table: "UserHeadImg",
